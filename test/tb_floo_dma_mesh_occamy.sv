...
module tb_floo_dma_mesh_occamy;
  ...
  localparam logic [47:0] StartAddr = 48'h1000_0000; // Starting Address of Group0
  localparam logic [47:0] EndAddr   = 48'h103f_ffff; // Ending Address of Group0
  // Addr Map
  // +----------------+-------------+-------------+-------------+-------------+
  // |                | 1,4         | 2,4         | 3,4         | 4,4         |
  ...
  // +----------------+-------------+-------------+-------------+-------------+
  // | 0,1            | 1,1         | 2,1         | 3,1         | 4,1         |
  // | 0x10_0000_0000 | 0x1000_0000 | 0x1004_0000 | 0x1008_0000 | 0x100c_0000 |
  // | 0x10_3fff_ffff | 0x1003_ffff | 0x1007_ffff | 0x100b_ffff | 0x100f_ffff |
  // +----------------+-------------+-------------+-------------+-------------+

  localparam bit en_default_idx = 1'b1;
  localparam xy_id_t default_idx = '{x: 0, y: 1};
  logic clk, rst_n;
